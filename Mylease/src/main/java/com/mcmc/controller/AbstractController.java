...
//
//import com.mcmc.common.core.Assert;
//import com.mcmc.common.exception.ContextException;
...
//		AbstractController.context = this.getServletContext();// 创建servletContext对象
...
//		BeanToJson beanToJson = this.jsonStr;
//		beanToJson.put(key, t);
...
////		try {
////			Class<? extends AbstractController> controllerClazz = this .getClass();
////
...
//
//	/**
//	 * @param actionReturn the actionReturn to set
//	 */
